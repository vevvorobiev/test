...
/* extension/module/category_wall.twig */
class __TwigTemplate_04eee2f86e8b4558a4583c7dcd50922e8043e4aaa619fb97d44104a981380783 extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container-fluid\">
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <select name=\"module_category_wall_height_status\" id=\"input-height-status\" class=\"form-control\">
                    <option value=\"1\" ";
        // line 94
        if ((($context["module_category_wall_height_status"] ?? null) == 1)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_enabled"] ?? null);
        echo "</option>
                    <option value=\"0\" ";
        // line 95
        if ((($context["module_category_wall_height_status"] ?? null) == 0)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_disabled"] ?? null);
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <select name=\"module_category_wall_image_status\" id=\"input-image-status\" class=\"form-control\">
                    <option value=\"1\" ";
        // line 126
        if ((($context["module_category_wall_image_status"] ?? null) == 1)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_enabled"] ?? null);
        echo "</option>
                    <option value=\"0\" ";
        // line 127
        if ((($context["module_category_wall_image_status"] ?? null) == 0)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_disabled"] ?? null);
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <input type=\"text\" name=\"module_category_wall_image_width\" value=\"";
        // line 134
        echo ($context["module_category_wall_image_width"] ?? null);
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <input type=\"text\" name=\"module_category_wall_image_height\" value=\"";
        // line 143
        echo ($context["module_category_wall_image_height"] ?? null);
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <select name=\"module_category_wall_description_status\" id=\"input-description-status\" class=\"form-control\">
                    <option value=\"1\" ";
        // line 153
        if ((($context["module_category_wall_description_status"] ?? null) == 1)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_enabled"] ?? null);
        echo "</option>
                    <option value=\"0\" ";
        // line 154
        if ((($context["module_category_wall_description_status"] ?? null) == 0)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_disabled"] ?? null);
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <input type=\"text\" name=\"module_category_wall_description_length\" value=\"";
        // line 161
        echo ($context["module_category_wall_description_length"] ?? null);
        echo "\" placeholder=\"";
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <select name=\"module_category_wall_categories_type\" class=\"form-control\" id=\"input-categories-type\">
                    <option value=\"all\" ";
        // line 171
        if ((($context["module_category_wall_categories_type"] ?? null) == "all")) {
            echo "selected=\"selected\"";
        }
        echo ">";
        ...
        // line 172
        if ((($context["module_category_wall_categories_type"] ?? null) == "selected")) {
            echo "selected=\"selected\"";
        }
        echo ">";
        ...
        echo "</option>
                    <option value=\"custom\" ";
        // line 173
        if ((($context["module_category_wall_categories_type"] ?? null) == "custom")) {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "                      <div class=\"checkbox\">
                        <label>
                          <input type=\"checkbox\" name=\"module_category_wall_categories_selected[]\" value=\"";
            // line 187
            echo twig_get_attribute($this->env, $this->source, $context["category"], "category_id", [], "any", false, false, false, 187);
            echo "\" ";
            if (twig_in_filter(twig_get_attribute($this->env, $this->source, $context["category"], "category_id", [], "any", false, false, false, 187), ($context["module_category_wall_categories_selected"] ?? null))) {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "
                          <input type=\"checkbox\" class=\"hidden\" name=\"module_category_wall_categories_custom[]\" value=\"";
            // line 208
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <select name=\"module_category_wall_subcategory_status\" id=\"input-subcategory-status\" class=\"form-control\">
                    <option value=\"1\" ";
        // line 225
        if ((($context["module_category_wall_subcategory_status"] ?? null) == 1)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_enabled"] ?? null);
        echo "</option>
                    <option value=\"0\" ";
        // line 226
        if ((($context["module_category_wall_subcategory_status"] ?? null) == 0)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_disabled"] ?? null);
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <input type=\"text\" name=\"module_category_wall_subcategory_limit\" value=\"";
        // line 233
        echo ($context["module_category_wall_subcategory_limit"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["placeholder_limit_cancel"] ?? null);
        ...
        echo "</label>
                <div class=\"col-sm-10\">
                  <select name=\"module_category_wall_subcategory_collapse_status\" id=\"input-subcategory-collapse-status\" class=\"form-control\">
                    <option value=\"1\" ";
        // line 243
        if ((($context["module_category_wall_subcategory_collapse_status"] ?? null) == 1)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_enabled"] ?? null);
        echo "</option>
                    <option value=\"0\" ";
        // line 244
        if ((($context["module_category_wall_subcategory_collapse_status"] ?? null) == 0)) {
            echo "selected=\"selected\"";
        }
        echo ">";
        echo ($context["text_disabled"] ?? null);
...
\$(window).on('load', function () {
  ...
  \$('input#form-group-categories-input').autocomplete({
    ...
    'select': function(item) {
      ...
      \$('#product-category').append('<div class=\"checkbox\"><label id=\"product-category' + item['value'] + '\"><i class=\"fa fa-minus-circle\"></i> ' + item['label'] + '<input type=\"checkbox\" name=\"module_category_wall_categories_custom[]\" value=\"' + item['value'] + '\" class=\"hidden\" checked=\"checked\"></label></div>');
      countCategories();
    }
  });
...
";
    ...
    {
        return "extension/module/category_wall.twig";
    }
    ...
    {
        return new Source("", "extension/module/category_wall.twig", "");
    }
}
